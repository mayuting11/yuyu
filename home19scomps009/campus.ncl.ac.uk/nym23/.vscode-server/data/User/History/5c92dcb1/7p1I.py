...
def Modified_ANT(ax,file_path,usernode,nodeid,exitnodeid,num_exit,deadline):
    ...
    node_x=pandas.read_excel(file_path,names=None,usecols=[1])
    nodex=[]
    ...
    node_y=pandas.read_excel(file_path,names=None,usecols=[2])
    nodey=[]
    ...
    #read edge data
    edge_from_id=pandas.read_excel(file_path,names=None,usecols=[4])
    edgefromid=[]
    ...
    edge_to_id=pandas.read_excel(file_path,names=None,usecols=[5])
    edgetoid=[]
